...
Die Themen Machine Learning, Data Mining, Data Analysis und Data Science stellen zwar verwandte Begriffe dar, sind jedoch alles eigene Felder. \newline
...
\end{itemize}
Neben Schnittpunkten zu Künstlicher Intelligenz, Machine Learning und der Statistik, befasst sich Data Mining ebenfalls mit Datenbanksystemen.\citep[S.~4]{ramasubramanian_machine_2017} \newline
...
\end{enumerate}
Dazu bedient sich sich der deskriptiven Statistik, der explorativen Datentenanalyse (engl. Explorative Data Analysis; EDA) und der Induktiven Statistik.\citep[S.~17]{hertle_datenanalyse_2016}\newline
Um 
\begin{itemize}
