...
Laut einer Studie von \citep{bitkom_welche_2017} greifen 23\% der Befragten Unternehmen in Deutschland neben "Office Anwendungen aus der Cloud", "Security as a Service" und "Groupware" auf "Business Intelligence/Big Data"-Software aus der Cloud zurück. Zu dieser Kategorie gehört auch Azure Machine Learning (kurz: Azure ML) von Microsoft, welches zur Analyse in dieser Arbeit genutzt wird.



was is saas
welche vorteile bietet es
deswegen umsatz steigerung + prognose
zu sehen an reinen cloud anbietern sales force > sap crm
neben hauptanwendungen office, security, groupware und collaboration etc. 23\% BI/Big data
hier AZure
