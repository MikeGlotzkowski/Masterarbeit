...
\end{itemize}
Nachfolgend wird das Bereinigen und Zusammensetzten beschrieben. Zuerst werden die Aktienindices bearbeitet (Listing \ref{list:indicesR}) und gejoint und (Abbildung \ref{fig:indicesAzure_1}). Daraufhin werden sie nachbearbeitet (Abbildung \ref{fig:indicesAzure_2}).
...
pseudo-numerische Werte (1.5M) & \todo{wie macht man das genau mit den Kommas?} & \\
