...
\textbf{Datensatz} & \textbf{Reichweite} & \textbf{Besonderheiten}\\ 
\hhline{===}
ETHPriceVolumeFullDaily & 7.8.2015 bis 5.11.2017 & historische Kursdaten für ETC (Preis und Volumen); Datum in einem Format mit Text (!) \\ \hhline{===}
\multicolumn{3}{|c|}{BTC/USD-Kurs}\\ \hline
\textbf{Datensatz} & \textbf{Reichweite} & \textbf{Besonderheiten}\\ 
\hhline{===}
BTCPriceVolumeFullDaily & 13.9.2011 bis 6.11.2017 & historische Kursdaten für BTC (Preis und Volumen);  \\ \hhline{===}
