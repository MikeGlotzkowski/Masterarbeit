...
\begin{longtable}[!h]{|p{6cm}|p{4cm}|p{5cm}|}
\hline
\textbf{Datensatz} & \textbf{Reichweite} & \textbf{Besonderheiten}\\ 
\hhline{===}
\multicolumn{3}{|c|}{Cryptowährungs-eigene Faktoren}\\ \hline
BTC\_total\_volume\_daily\_full.csv & 3.1.2009 bis 5.11.2017 & teilweise kein Anstieg des Volumens im Datensatz; Lücken im Datensatz \\ \hline
BTC\_difficulty\_daily\_full.csv & 6.11.2012 bis 5.11.2017 & Zeit in UTC \\ \hline
