...
STLFSI & numerisch (Gleitkommazahl) mit drei Nachkommastellen & im Intervall von [-1,586;3,246] \\ \hline
...
btc \textunderscore output \textunderscore volume & numerisch (Gleitkommazahl) mit bis zu sieben Nachkommastellen & viele Anfangswerte sind glatte Zehner \\ \hline
btc \textunderscore estimated \textunderscore transaction \textunderscore volume & numerisch (Gleitkommazahl) mit bis zu sechs Nachkommastellen & Nachkommastellen erst ab 20.4.2016 \\ \hline
btc \textunderscore estimated \textunderscore transaction \textunderscore volume \textunderscore usd & numerisch (Gleitkommazahl) mit bis zu vier Nachkommastellen & Nachkommastellen erst ab 20.4.2016 \\ \hline
...
eth \textunderscore etherprice & numerisch (Gleitkommazahl) mit bis zu zwei Nachkommastellen & bbb \\ \hline
eth \textunderscore tx & numerisch (Ganzzahl) & \\ \hline
eth \textunderscore address & numerisch (Ganzzahl) & Werte stetig steigend \\ \hline
eth \textunderscore supply & numerisch (Gleitkommazahl) mit bis zu vier Nachkommastellen &  Werte stetig steigend \\ \hline
eth \textunderscore marketcap & numerisch (Gleitkommazahl) mit bis zu neun Nachkommastellen & \\ \hline
eth \textunderscore hashrate & numerisch (Gleitkommazahl) mit bis zu vier Nachkommastellen & \\ \hline
eth \textunderscore difficulty & numerisch (Gleitkommazahl) mit bis zu drei Nachkommastellen & die ersten drei Werte sind < 0, was der Definition der Schwierigkeit widerspricht \\ \hline
eth \textunderscore blocks & numerisch (Ganzzahl) & immer vierstellig \\ \hline
eth \textunderscore uncles & numerisch (Ganzzahl) & \\ \hline
eth \textunderscore blocksize & numerisch (Ganzzahl) & \\ \hline
eth \textunderscore blocktime & numerisch (Gleitkommazahl) mit bis zu zwei Nachkommastellen & Nur Werte im Intervall [4,46;30,31]\\ \hline
eth \textunderscore gasprice & numerisch (Ganzzahl) & \\ \hline
eth \textunderscore gaslimit & numerisch (Ganzzahl) & vermutlich stufenhafter Anstieg/Abfall \\ \hline
eth \textunderscore gasused & numerisch (Ganzzahl) & \\ \hline
eth \textunderscore ethersupply & numerisch (Gleitkommazahl) mit bis zu fünf Nachkommastellen & \\ \hline
eth \textunderscore ens \textunderscore register & numerisch (Ganzzahl) & von 30.7.2015 bis 3.5.2017 keine Daten; von 4.5.2017 bis 8.5.2017 immer Nullwerte \\ \hline
...
\centering
\end{figure}
Anzumerken ist hier, dass die historischen Kursdaten hier in keinem Verhältnis zur y-Achse stehen und nur der grafischen Darstellung dienen.



\todo{analog eth; schlussfolgerung}
wiki search/google plotten und sagen, dass bekannt erst ab xyz



Kann man über die ersten Zeit immer was sagen? V.A bei bitcoin? einfahc zu unbekannt, als das faktoren relevant wären (common sense...); für nacher festhalten, dass eine analyse mit ganzem satz und eine erst am aa.bb.cccc

Output Data exploration report


Wie zu sehen ist, sind die Teilschritte und Phasen im CRISP-DM-Referenzmodell nicht strikt von einander getrennt, sondern gehen 

\subsection{Verify Data Quality}
Ziel: Qualität sichern; common sense
--> alle preise in usd; zeit in ttmmyyyy oder so
--> einige lücken
--> kommas und punkte nicht immer richtig; erstezen
--> fehler bei difficult? oder einfacher um am anfang initial zu schürfen?!
...
hierher zurück und fehler in den daten beschriebn, wenn welche auftauchen!

\section{Data Preperation}
\subsection{Select Data}
Ziel: Welche Daten sind wichtig für die Analyse?
--> textding überführen in 1 und 0
--> paar indices killen
--> einige features killen: prozentualer ansteig zB
--> teilweise doppelte sachen wie difficulty, dann überprüfen, ob gleich und dann 1 killen
