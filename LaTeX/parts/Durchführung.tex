...
Daraufhin werden sie nachbearbeitet. Die nachfolgende Beschreibung bezieht sich auf Abbildung \ref{fig:indicesAzure_2}. In jedem Datensatz existiert eine Spalte, die die Zeilen durchnummeriert. Dies diente zum beheben von Fehlern. Diese Spalte wird entfernt (1. Select Columns in Dataset). Ebenso enthält das Ergebnis noch 35 Datums-Spalten. Diese können auf Eine reduziert werden (2. Select Columns in Dataset und Edit Metadata).
\begin{figure}[H]
\frame{
