...
\item Zusätzliche Eigenschaften von Bitcoin und Ethereum. Kumar stellt unter der 'CC0: Public Domain'-Lizenz einen Datensatz zur Verfügung, der besondere Eigenschaften der Währungen enthält \citep{kumar_cryptocurrency_2017}. Beispiele für Bitcoin sind die "Anzahl der einzigartigen Adressen" in der "Bitcoin Blockchain"; oder die "Anzahl der uncles pro Tag" \citep[eigene Übersetzung]{kumar_cryptocurrency_2017} für Ethereum.
\end{itemize}
\\
\hline
...
\subsection{Inkludieren und Exkludieren von Daten (Select Data)}
